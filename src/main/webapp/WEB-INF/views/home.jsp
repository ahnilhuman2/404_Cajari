					...
					<div id="carouselExampleControls" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img src="./Image/search.png" class="d-block w-100"
									alt="Cajari2">
							</div>

							<div class="carousel-item">
								<img src="./Image/information.png" class="d-block w-100"
									alt="Cajari3">
							</div>
					...
					<div class="col-lg-4">
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body">
								...
								<a href="${pageContext.request.contextPath }/search/search_map"
									class="btn btn-dark">Map Search</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body">
								...
								<a
									href="${pageContext.request.contextPath }/search/search_basic"
									class="btn btn-dark">Basic Search</a>
							</div>
						</div>
					</div>
